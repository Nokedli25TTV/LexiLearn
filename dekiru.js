...
const DEKIRU_L1 = [
  ...
  { kana: 'ハンがリー', romaji: 'hangari', hu: 'Magyarország', tags: ['országok'], jlpt: 'N5', lesson: [1], source: 'dekiru' },
  ...
  { kana: 'れい', romaji: 'rei', hu: 'példa', tags: ['iskola'], jlpt: 'N5', lesson: [1], source: 'dekiru' },
...
const DEKIRU_L2 = [
  ...
  { kana: 'いけ', romaji: 'ike', hu: 'tó, mesterséges tó', tags: ['természet'], jlpt: 'N5', lesson: [2], source: 'dekiru' },
  ...
  { kana: 'でんしじしょ', romaji: 'denshijisho', hu: 'elektronikus szótár' },
  ...
  { kana: 'でんわ', romaji: 'denwa', hu: 'telefon', tags: ['tárgyak'], jlpt: 'N5', lesson: [2], source: 'dekiru' },
  ...
  { kana: 'かし', romaji: 'kashi', hu: 'édesség/sütemény ', tags: ['ételek'], jlpt: 'N5', lesson: [2], source: 'dekiru' },
  { kana: 'まんじゅう', romaji: 'manjuu', hu: 'manjú (édesség)', tags: ['ételek'], jlpt: 'N5', lesson: [2], source: 'dekiru' },
...
const DEKIRU_L4 = [
  ...
  { kana: 'あさ', romaji: 'asa', hu: 'reggel', tags: ['idő'], jlpt: 'N5', lesson: [4], source: 'dekiru' },
  ...
  { kana: 'ひとつ', romaji: 'hitotsu', hu: 'egy', tags: ['számlálószavak'], jlpt: 'N5', lesson: [4], source: 'dekiru' },
  ...
  { kana: 'ななつ', romaji: 'nanatsu', hu: 'hét', tags: ['számlálószavak'], jlpt: 'N5', lesson: [4], source: 'dekiru' },
...
const DEKIRU_L6 = [
  ...
  { kana: 'てがみ', romaji: 'tegami', hu: 'levél', tags: ['kommunikáció'], jlpt: 'N5', lesson: [6], source: 'dekiru' },
  ...
  { kana: 'こんや', romaji: 'konya', hu: 'ma este, ma éjjel', tags: ['idő'], jlpt: 'N5', lesson: [6], source: 'dekiru' },
...
const DEKIRU_L9 = [
  ...
  { kana: 'べんり', romaji: 'benri', hu: 'kényelmes, praktikus', tags: ['alapszavak'], jlpt: 'N4', lesson: [9], source: 'dekiru' } // [cite: 1172]
];
const DEKIRU_L10 = [
  // Igék
...
const DEKIRU_L12 = [
  ...
  { kana: 'そうだんする', romaji: 'soudansuru', hu: 'megbeszél, megtárgyal', tags: ['igék'], jlpt: 'N5', lesson: [12], source: 'dekiru' }, // [cite: 1477, 1469]
...
const DEKIRU_L18 = [
  ...
  { kana: 'ブルがリア', romaji: 'burugaria', hu: 'Bulgária', tags: ['országok'], jlpt: 'N5', lesson: [18], source: 'dekiru' }, // [cite: 2084]
...
const DEKIRU_L20 = [
  ...
  { kana: 'がス', romaji: 'gasu', hu: 'gáz, szénsav', tags: ['alapszavak'], jlpt: 'N5', lesson: [20], source: 'dekiru' },
